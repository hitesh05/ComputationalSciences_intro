...
column_1 = merged_df["Male"]
column_2 = merged_df["Total"]
correlation = column_1.corr(column_2)
print("Total male literacy and child mortality: ",correlation)
#print(correlation)
print()

column_1 = merged_df["Female"]
column_2 = merged_df["Total"]
correlation = column_1.corr(column_2)
print("Total female literacy and child mortality: ",correlation)
#print(correlation)
print()